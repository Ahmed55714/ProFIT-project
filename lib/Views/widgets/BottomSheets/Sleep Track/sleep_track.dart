    ...
    return Column(
      ...
      children: [
        ...
        CustomButton(
          text: 'Add Sleep Time',
          onPressed: () async {
            final fallAsleepTime = controller.formatTime(controller.startAngle.value);
            final wakeUpTime = controller.formatTime(controller.endAngle.value);

            await controller.saveSleepTrack(fallAsleepTime, wakeUpTime);
