...
class Snack extends StatefulWidget {
  ...
  Snack({Key? key, this.isExpanded = false, this.planId}) : super(key: key);
          ...
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return Obx(() {
              ...
              final meals = data.isNotEmpty
                  ? data[0].meals.where((meal) => meal.mealType == 'Snack').toList()
                  : [];
                  ...
                  return Column(
                    children: [
                      const MealInfoContainer(
                        ...
                        mealName: 'Snack',
                        description: 'A balanced snack to keep you energized.',
                        nutrients: [
                          {'value': '10 gm', 'icon': 'assets/svgs/ch.svg'},
                          {'value': '8 gm', 'icon': 'assets/svgs/waterdropo.svg'},
                          {'value': '15 gm', 'icon': 'assets/svgs/food.svg'},
                          {'value': '150 Kcal', 'icon': 'assets/svgs/Flamea.svg'},
                        ],
                      ),
                      CustomRecipeCard1(
...
class Snack2 extends StatelessWidget {
  ...
  Snack2({Key? key, this.isExpanded = false, this.planId}) : super(key: key);
