...
class _ChatScreenState extends State<ChatScreen> {
  ...
  Future<void> _fetchMessagesTwice() async {
    await chatController.fetchMessages(widget.conversation.id);
    await chatController.fetchMessages(widget.conversation.id);
     await chatController.fetchMessages(widget.conversation.id);
  }
  ...
  Future<void> _sendMessage() async {
    ...
    _scrollToBottom();
    await _fetchMessagesTwice(); // Fetch messages twice after sending
  }
    ...
    try {
      ...
      if (pickedFile != null) {
        ...
        Navigator.push(
          ...
          if (value == true) {
            await _fetchMessagesTwice(); // Refetch messages twice after sending image
          }
        });
      }
    } catch (e) {
