...
class _HeartRateScreenState extends State<HeartRateScreen> {
      ...
      builder: (context) => HeartBPMDialog(
        ...
        onBPM: (bpm) {
          ...
          if (recentBPMs.length == 3 &&
            ...
            // Close the dialog and allow user to confirm
  ...
  void _confirmHeartRate() {
    if (currentHeartRate != null) {
      _postHeartRateData(currentHeartRate!);
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              CustomButton(
                ...
                onPressed: isMeasuring ? null : _startHeartRateMeasurement,
              ),
              const SizedBox(height: 16),
              if (currentHeartRate != null) ...[
                CustomButton(
                  text: 'Confirm Heart Rate',
                  onPressed: _confirmHeartRate,
                ),
                const SizedBox(height: 16),
              ],
            ],
