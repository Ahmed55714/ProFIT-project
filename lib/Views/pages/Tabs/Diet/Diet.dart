...
import '../../Diet/Plan Active/controller/plan_active.dart';
...
class DietScreen extends StatelessWidget {
  ...
  final DietPlanActiveController dietPlanActiveController = Get.put(DietPlanActiveController());
            ...
            Padding(
              ...
              child: Column(
                children: [
                  ...
                  Obx(() {
                    if (dietPlanActiveController.isLoading.value) {
                      return Center(child: CircularProgressIndicator());
                    }

                    final planDetails = dietPlanActiveController.activePlanDetails.value;
                                ...
                                children: [
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        dailyMacros?.calories.toStringAsFixed(0) ?? '0',
